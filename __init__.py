...
cors = CORS(app, supports_credentials=True, origins=['http://localhost:4100', 'http://127.0.0.1:4100/joblyFrontend/', 'http://127.0.0.1:8064', 'https://aidanlau10.github.io/joblyFrontend/'])
